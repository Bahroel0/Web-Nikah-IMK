      ...
      @media only screen and (min-width: 993px) {
        ...
        <div class="container">
            ...
            <pre>
                ...
                I.  1. Nama lengkap dan alias                 : '. $hasilwanita["nama_lengkap"].'
                    2. Tempat tanggal lahir                      : '. $hasilwanita["tempat_lahir"].', ' .$hasilwanita["tanggal_lahir"].'
                    3. Warganegara                                  : '. $hasilwanita["warganegara"].'
                    4. Agama                                            : '. $hasilwanita["agama"].'
                    5. Pekerjaan                                        : '. $hasilwanita["pekerjaan"].'
                    6. Tempat tinggal                                : '. $hasilwanita["tempat_tinggal"].'
