<!DOCTYPE html>
  <html>
    ...
    <div id="form1" class="col s12">
      ...
      <div class="container">
        <div class="row" style="margin-top: 20px">
          <form name="form-pria" id="form-pria" action="form1.php" method="POST" class="col s12">
            <div class="row">
              <div class="input-field col s4">
                <i class="material-icons prefix">account_balance</i>
                <input id="icon_kota" name="kabupaten" type="text" class="validate" required="" aria-required="true">
                <label for="icon_kota" data-error="wajib diisi" data-success="">Kabupaten/Kota</label>
              </div>
              <div class="input-field col s4">
                <i class="material-icons prefix">account_balance</i>
                <input id="icon_kecamatan" name="kecamatan" type="text" class="validate" required="" aria-required="true">
                <label for="icon_kecamatan" data-error="wajib diisi" data-success="">Kecamatan</label>
              </div>
              <div class="input-field col s4">
                <i class="material-icons prefix">account_balance</i>
                <input id="icon_desa" type="text" name="desa" class="validate" required="" aria-required="true">
            ...
            <div class="row">
              <div class="input-field col s4">
                ...
                <input id="icon_nama" type="text"name="nama_lengkap" class="validate" required="" aria-required="true">
                <label for="icon_nama" data-error="wajib diisi" data-success="">Nama Lengkap</label>
              </div>
              <div class="input-field col s4">
                <i class="material-icons prefix">account_box</i>
                <input id="icon_bin" type="text" name="nama_ayah" class="validate" required="" aria-required="true">
            ...
            <div class="row">
              ...
              <div class="input-field col s4">
                <input placeholder="Tempat" type="text" name="tempat_lahir" class="validate" required="" aria-required="true">
              </div>
              <div class="input-field col s4">
                <input placeholder="Tanggal" type="text" name="tanggal_lahir" class="datepicker" required="" aria-required="true">
              </div>
              <div class="col s12"></div>
              <div class="input-field col s4">
                <input placeholder="Warga Negara" type="text" name="warganegara" class="validate" required="" aria-required="true">
              </div>
              <div class="input-field col s4">
                <select name="agama" class="validate" required="" aria-required="true">
              ...
              <div class="input-field col s4">
                <input placeholder="Pekerjaan" name="pekerjaan" type="text" class="validate"  required="" aria-required="true">
              </div>
            </div>

            <div class="row">
              <div class="input-field col s12">
                <textarea id="alamat" class="materialize-textarea validate" name="tempat_tinggal" required="" aria-required="true"></textarea>
            ...
            <div class="row">
              ...
              <div class="input-field col s2">
                <select id="status_kawin" onchange="statusKawin()" name="status" class="validate" required="" aria-required="true">
                  <option disabled selected>Pilih</option>
              ...
              <div id="status_kawin_add" class="input-field col s4 offset-s1 none">
                ...
                <input id="mantan" placeholder="Nama Istri Anda terdahulu" type="text" name="nama_istri_terdahulu">
              </div>
            </div>
    ...
    <div id="form2" class="col s12">
      ...
      <form id="form-pria2" class="col s12" action="form2.php" method="POST">
        <div class="row">
          <div class="col s6">
              <div class="container">
                <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="input-field col s4">
                    <input name="tanggal_ayah" placeholder="Tanggal" type="text" class="datepicker" required="" aria-required="true">
                  </div>
                  <div class="col s12"></div>
                  <div class="input-field col s4">
                  ...
                  <div class="input-field col s12">
                    <textarea name="alamat_ayah" id="alamat" class="materialize-textarea" required="" aria-required="true"></textarea>
          ...
          <div class="col s6">
              <div class="container">
                ...
                <div class="row">
                  ...
                  <div class="input-field col s4">
                    <input name="tanggal_ibu" placeholder="Tanggal" type="text" class="datepicker" required="" aria-required="true">
                  </div>
                  <div class="col s12"></div>
                  <div class="input-field col s4">
                  ...
                  <div class="input-field col s4">
                    <select name="agama_ibu" required="" aria-required="true">
                      <option value="" disabled selected>Pilih</option>
                      <option value="1">Islam</option>
                      <option value="2">Hindu</option>
                      <option value="1">Budha</option>
                  ...
                  <div class="input-field col s12">
                    <textarea name="alamat_ibu" id="alamat" class="materialize-textarea" required="" aria-required="true"></textarea>
                    <label for="alamat">Alamat Tempat Tinggal</label>
                  </div>
                </div>
              </div>
          ...
          <div class="col s3 offset-s9">
            <button id="btn-form2" class="btn waves-effect waves-light no-uppercase" type="submit" name="submit" value="submit">Lanjutkan
              <i class="material-icons right">send</i>
            </button>
          </div>
        </div>
    ...
    <div id="form3" class="col s12">
        ...
        <div class="container">
          <form id="form-pria3" class="col s12" action="form3.php" method="POST">
            <div class="row">
            ...
            <div class="row">
              ...
              <div class="input-field col s4">
                <input name="tanggal_lahir" placeholder="Tanggal" type="text" class="datepicker" required="" aria-required="true">
              </div>
              <div class="col s12"></div>
              <div class="input-field col s4">
              ...
              <div class="input-field col s12">
                <textarea name="alamat"  id="alamat" class="materialize-textarea" required="" aria-required="true"></textarea>
                <label for="alamat">Alamat Tempat Tinggal</label>
              </div>
            </div>
    ...
    <div id="form4" class="col s12">
      <div class="header-form">
        <h5>Lewati Form ini Jika Anda Bukan Duda atau Duda karena bercerai</h5>
      </div>
      <div class="container">
          <form id="form-pria4" class="col s12" action="form4.php" method="POST">
          <div class="row"></div>
          <div class="row"></div>
            <div class="row">
              <h5>Silahkan Lengkapi Data Kematian Istri</h5>
            </div>
            <div class="row">
              <div class="input-field col s4">
                <input name="nama_lengkap" placeholder="Nama Lengkap" type="text" class="validate" required="" aria-required="true">
            ...
            <div class="row">
              ...
              <div class="col s12">
                ...
                <div class="input-field col s12">
                  <input name="meninggal_pada" placeholder="tgl/bln/thn" type="text" class="datepicker" required="" aria-required="true">
                </div>
              </div>
              <div class="input-field col s12">
                <textarea name="alamat" id="alamat" class="materialize-textarea" required="" aria-required="true"></textarea>
            ...
            <button id="btn-lewati" class="btn waves-effect waves-light no-uppercase right" >Lewati
            </button>
    ...
    <div id="form5" class="col s12">
      ...
      <div class="container">
        <form action="form5.php" class="col s12" method="POST">
          <div class="row">
            <div class="input-field col s4">
              <input name="hari" placeholder="Hari" type="text" class="validate" required="" aria-required="true">
            </div>
            <div class="input-field col s4">
                <input name="tanggal" placeholder="Tanggal" type="text" class="datepicker" required="" aria-required="true">
            </div>
            <div class="input-field col s4">
                <input name="jam" placeholder="00:00" type="text" class="timepicker" required="" aria-required="true">
            </div>
          </div>
          <div class="row">
            <div class="col s4">
            ...
            <div class="col s4">
              Dibayar :
              <div class="input-field inline" >
                <select name="dibayar" required="" aria-required="true">
          ...
          <br><br>
          <button class="btn waves-effect waves-light no-uppercase left" type="submit" name="submit" value="submit">Lanjutkan
              <i class="material-icons right">send</i>
          </button>
        </form>
        <br><br>
        ...
        $("#form-pria").submit(function (e){
            ...
            $.ajax({
              ...
              data : postData,
              success: function(){
                // var $toastContent = $('<span>Data Sudah DiSimpan</span>');
